@extends('layouts.app')
@section('title', $club->name . ' — Audit Log')
@section('page-title', $club->name . ' — Audit Log')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="mb-0 fw-bold">Audit Log</h5>
        <div class="text-muted small">Activity history for {{ $club->name }}</div>
    </div>
</div>
...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body py-3">
        <form method="GET" action="{{ route('admin.clubs.audit-logs', $club) }}" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            @if(request()->hasAny(['action','from','to','search']))
            <div class="col-auto">
                <a href="{{ route('admin.clubs.audit-logs', $club) }}" class="btn btn-outline-secondary btn-sm">Clear</a>
            </div>
            @endif
        </form>
    </div>
            ...
            <table class="table table-hover mb-0 small">
                ...
                <tr>
                    ...
                    <td style="max-width:350px">
                        <span class="text-truncate d-inline-block" style="max-width:345px" title="{{ $log->description }}">
                            {{ $log->description }}
                        </span>
                    </td>
